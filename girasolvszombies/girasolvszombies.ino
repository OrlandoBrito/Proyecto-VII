...
#define DHT11_PIN 30 //Seleccionamos el pin en el que se //conectará el sensor
#define DHTTYPE DHT11 //Se
int Hum_suelo=A0;
int Luminosidad=A1;
int luz = 0;       
int valor_sensor = 0;
...
for(int i=0;i<1000;i++)
{
  ...
  {Serial.println("boton 4");delay(400);
    Serial3.write("4");
    digitalWrite(23,LOW);
    digitalWrite(pin_riego,HIGH);//se enciende el motor
    delay(35000);//se lo deja funcionando por 35 seg
